...
const Button = tw.button`inline-flex items-center border px-4 border-transparent rounded-2xl shadow-sm ring-1 ring-black text-black bg-white bg-opacity-90 hover:(bg-opacity-100)`
